...
HD_PWD='/home/sethkonynenbelt/counter_vhdl/counter_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_vhdl.tcl

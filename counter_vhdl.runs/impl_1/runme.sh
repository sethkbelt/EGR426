...
HD_PWD='/home/sethkonynenbelt/counter_vhdl/counter_vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_vhdl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_vhdl.tcl -notrace
